...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[only marks, mark=*, mark size=2pt, color=TolMutedSand] coordinates {(-0.5, 0.0)};
            \addlegendentry{$q_1$};
            \addplot[only marks, mark=*, mark size=2pt, color=TolMutedOlive] coordinates {(0.5, 0.0)};
            \addlegendentry{$q_2$};
            % Curve and quiver+-
...
{\color{red}TODO: Do a Forward Euler simulation on a nice physics problem}
