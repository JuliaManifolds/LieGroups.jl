...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            % Quiver plot from CSV file
            \addplot[
                quiver={u=\thisrow{up}, v=\thisrow{vp}, scale arrows=\arrowscale}, TolMutedBlue, forget plot,
            ] table[col sep=comma] {data/ex2_rod_1_sparse.csv};
            \addplot[
                quiver={u=\thisrow{um}, v=\thisrow{vm}, scale arrows=\arrowscale}, TolMutedBlue, forget plot,
            ] table[col sep=comma] {data/ex2_rod_1_sparse.csv};
            % Plot the base points from CSV file
            \addplot[
            ...
            % Quiver plot from CSV file
            \addplot[
                quiver={u=\thisrow{up}, v=\thisrow{vp}, scale arrows=\arrowscale}, TolMutedGreen, forget plot,
            ] table[col sep=comma] {data/ex2_rod_2_sparse.csv};
            \addplot[
                quiver={u=\thisrow{um}, v=\thisrow{vm}, scale arrows=\arrowscale}, TolMutedGreen, forget plot,
            ] table[col sep=comma] {data/ex2_rod_2_sparse.csv};
            % Plot the base points from CSV file
            \addplot[
            ...
            %
            % Curve and quiver+-
            \addplot[solid, thick, TolMutedWine] table[col sep=comma, x=x, y=y] {data/ex2_rod_3_dense.csv};
            \addlegendentry{$\gamma_3$}
            % Quiver plot from CSV file
            \addplot[
                quiver={u=\thisrow{up}, v=\thisrow{vp}, scale arrows=\arrowscale}, TolMutedWine, forget plot,
            ] table[col sep=comma] {data/ex2_rod_3_sparse.csv};
            \addplot[
                quiver={u=\thisrow{um}, v=\thisrow{vm}, scale arrows=\arrowscale}, TolMutedWine, forget plot,
            ] table[col sep=comma] {data/ex2_rod_3_sparse.csv};
            % Plot the base points from CSV file
            \addplot[
                only marks, mark=*, mark size=.5pt, TolMutedWine, forget plot,
            ] table[col sep=comma] {data/ex2_rod_3_sparse.csv};
        \end{axis}
    \end{tikzpicture}
    \caption{Three solution curves \(\gamma_1\) (blue), \(\gamma_2\) (green), and \(\gamma_3\) (wine) of a Lie group Heun method on the product of Lie groups \(\mathrm{SO}(2) \times \mathbb R^2\)
