...
% \footnote{in-place variant \texttt{lie\_bracket!($\frak g$, Z, X, Y)}.}
...
\end{align*}
where \(u_{\perp}\) is the vector perpendicular to \(u\). The pair \((p, \theta)\) represents a point on \(G_1\), while \((\dot{p}, \dot{\theta})\) is an element of the Lie algebra \(\mathfrak{g}_1\).
Hence the second order ODE on \(G_1\) can be converted to a first order ODE on \(G = G_1 \times \mathfrak{g}_1\) by introducing \((\dot{p}, \dot{\theta})\) as additional state variables.

This can be solved using Lie groups methods, such as the RKMK variant of the Heun method~\cite{IserlesMunthe-KaasNoersettZanna:2000}.

Code~\ref{lst:rod-dynamics} shows functions that calculate the right hand side of the ODE \lstinline{E_field} is a function that calculates electric field strength from the point charges at the given point.
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addlegendentry{$q_2$};
            % Curve and quiver+-
            \addplot[solid, thick, TolMutedBlue] table[col sep=comma, x=x, y=y] {data/ex2_rod_1_dense.csv};
            \addlegendentry{$\gamma_1$}
            % Quiver plot from CSV file
            \addplot[
                quiver={u=\thisrow{up}, v=\thisrow{vp}, scale arrows=\arrowscale}, -{Bar[width=4pt]}, TolMutedBlue, forget plot,
            ] table[col sep=comma] {data/ex2_rod_1_sparse.csv};
            \addplot[
                quiver={u=\thisrow{um}, v=\thisrow{vm}, scale arrows=\arrowscale}, -{Circle[length=2pt]}, TolMutedBlue, forget plot,
            ] table[col sep=comma] {data/ex2_rod_1_sparse.csv};
            % Plot the base points from CSV file
            \addplot[
                only marks, mark=*, mark size=.5pt, TolMutedBlue, forget plot,
            ] table[col sep=comma] {data/ex2_rod_1_sparse.csv};
            %
            %
            % Curve and quiver+-
            \addplot[solid, thick, TolMutedGreen] table[col sep=comma, x=x, y=y] {data/ex2_rod_2_dense.csv};
            \addlegendentry{$\gamma_2$}
            % Quiver plot from CSV file
            \addplot[
                quiver={u=\thisrow{up}, v=\thisrow{vp}, scale arrows=\arrowscale}, -{Bar[width=4pt]}, TolMutedGreen, forget plot,
            ] table[col sep=comma] {data/ex2_rod_2_sparse.csv};
            \addplot[
                quiver={u=\thisrow{um}, v=\thisrow{vm}, scale arrows=\arrowscale}, -{Circle[length=2pt]}, TolMutedGreen, forget plot,
            ] table[col sep=comma] {data/ex2_rod_2_sparse.csv};
            % Plot the base points from CSV file
            \addplot[
                only marks, mark=*, mark size=.5pt, TolMutedGreen, forget plot,
            ] table[col sep=comma] {data/ex2_rod_2_sparse.csv};
            %
            %
            % Curve and quiver+-
            \addplot[solid, thick, TolMutedPurple] table[col sep=comma, x=x, y=y] {data/ex2_rod_3_dense.csv};
            \addlegendentry{$\gamma_3$}
            % Quiver plot from CSV file
            \addplot[
                quiver={u=\thisrow{up}, v=\thisrow{vp}, scale arrows=\arrowscale}, -{Bar[width=4pt]}, TolMutedPurple, forget plot,
            ] table[col sep=comma] {data/ex2_rod_3_sparse.csv};
            \addplot[
                quiver={u=\thisrow{um}, v=\thisrow{vm}, scale arrows=\arrowscale}, -{Circle[length=2pt]}, TolMutedPurple, forget plot,
            ] table[col sep=comma] {data/ex2_rod_3_sparse.csv};
            % Plot the base points from CSV file
            \addplot[
                only marks, mark=*, mark size=.5pt, TolMutedPurple, forget plot,
            ] table[col sep=comma] {data/ex2_rod_3_sparse.csv};
        \end{axis}
    \end{tikzpicture}
...
For more advanced methods of solving differential equations on Lie groups in Julia, see
