@testset "rigid motions" begin
    ...
    @testset "SE(3) group" begin
        u = [0.10492017733738712, 0.0515615817202169, 0.0854101556176815,
             0.0918368603828897, 0.06744175127091437, 0.11666345393900458]
        alg = se{3}(u)
        # @test LieGroups.right_jacobian(alg) ≈ 
    end
end
