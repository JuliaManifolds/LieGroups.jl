...
In a nutshell a Lie group $𝒢$ is a [manifold](https://en.wikipedia.org/wiki/Manifold) $ℳ$ that also is a group a group operation.
...
A Lie group is usually written as a tuple $(ℳ,∘)$ os the manifold and the group operation thereon.
