...
define!(:Math, :SU, :symbol, _tex(:rm, "SU"))
define!(:Math, :SU, :description, "the special unitary group")
define!(:Math, :SU, _math(:SU, :symbol))
define!(:Math, :u, :symbol, _tex(:frak, "u"))
define!(:Math, :u, :description, "the Lie Algebra of the unitary group")
define!(:Math, :u, _math(:u, :symbol))
define!(:Math, :U, :symbol, _tex(:rm, "U"))
define!(:Math, :U, :description, "the unitary group")
define!(:Math, :U, _math(:U, :symbol))
define!(:Math, :t, :symbol, _tex(:frak, "t"))
define!(:Math, :t, :description, "the Lie algebra of the translation group")
